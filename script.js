    ...
    document.getElementById('shareInterface').style.display = 'block';
        ...
        function shareOnPlatform(platform) {
            ...
            switch (platform) {
                ...
                break;
                case 'messenger':
                    shareURL = `https://xexanterxcin.github.io/Project-NFC-HUNT/404/`; //https://www.facebook.com/dialog/send?link=${encodeURIComponent(link)}&app_id=744478004594861&redirect_uri=${encodeURIComponent(link)}
                break;
                }
        ...
        function makeCall() {
            if (/Mobi|Android/i.test(navigator.userAgent)) {
                window.location.href = 'tel:+8801935674340';
            } else {
                alert('Calling: +8801935674340 (This would dial on a mobile device)');
            }
        }
